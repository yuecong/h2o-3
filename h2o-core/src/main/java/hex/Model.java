...
//      assert(mdomain != null); // label must be enum
  ...
  protected Frame scoreImpl(Frame fr, Frame adaptFrm, Vec row_weights, String destination_key) {
    ...
    BigScore bs = new BigScore(domains[0],ncols,row_weights, adaptFrm.means(),computeMetrics).doAll(ncols,adaptFrm);
    if (computeMetrics)
  ...
  private class BigScore extends MRTask<BigScore> {
    ...
    BigScore( String[] domain, int ncols, Vec row_weights, double[] mean, boolean computeMetrics ) {
